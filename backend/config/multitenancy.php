...
return [
     ...
     */
    // Where landlord (central) migrations live
    'landlord_migrations_path' => database_path('migrations/landlord'),

    // Where tenant migrations live
    'tenant_migrations_path' => database_path('migrations/tenant'),
    'tenant_database_connection_name' => 'tenant',

    'tenant_route_middleware_name' => 'tenant',

    'after_bootstrap_tenant_hooks' => [],
